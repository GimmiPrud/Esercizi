    ...
    def casual_number():
        ...
        while num1 != num_num:
            ...
            if num1 == num_num:
                ...
                return f"la tua ipotesi è piu alta del numero scelto, riprova numero tentativi: {tentativi}"
            else:
                return f"la tua ipotesi è più bassa del numero scelto, riprova numero tentativi: {tentativi}"
